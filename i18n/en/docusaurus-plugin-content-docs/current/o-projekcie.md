...
The project is released under the **Elastic License 2.0 (ELv2)**. You can:

- Use OpenKSeF for internal purposes (business and personal)
- Modify the source code
- Distribute modified versions
- Self-host at no cost

**Limitation:** you may not offer OpenKSeF as a hosted service (SaaS) without the author's permission. Details: [COMMERCIAL.md](https://github.com/open-ksef/open-ksef/blob/main/COMMERCIAL.md).

Full license text: [Elastic License 2.0](licencja)
